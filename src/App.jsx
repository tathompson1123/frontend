...
<body>
  ...
  <footer class="footer">
    ...
    /* Hero Section */
    .hero {
      background-image: url('https://source.unsplash.com/1920x1080/?${businessType.replace(/\s+/g, ',')},professional,outdoor,business');
      background-size: cover;
      background-position: center;
      min-height: 100vh;
      position: relative;
...
<body>
  ...
  <section class="services">
    ...
    <div class="service-grid">
      <div class="service-card">
        <img src="https://source.unsplash.com/800x600/?${businessType.replace(/\s+/g, ',')},service,work,professional" alt="Service 1">
      ...
      <div class="service-card">
        <img src="https://source.unsplash.com/800x600/?${businessType.replace(/\s+/g, ',')},professional,quality" alt="Service 2">
        <div class="service-card-content">
          <h3>Service Two</h3>
          <p>Professional service description here</p>
          <p class="price">$150</p>
      ...
      <div class="service-card">
        <img src="https://source.unsplash.com/800x600/?${businessType.replace(/\s+/g, ',')},premium,expert" alt="Service 3">
        <div class="service-card-content">
          <h3>Service Three</h3>
          <p>Professional service description here</p>
          <p class="price">$225</p>
  ...
  <section class="testimonials">
    ...
    <div class="testimonial-grid">
      <div class="testimonial">
        <div class="stars">⭐⭐⭐⭐⭐</div>
        <p>"Outstanding service! Highly recommend to anyone looking for quality work."</p>
        <div class="author">
          <img src="https://source.unsplash.com/150x150/?portrait,professional,male,headshot" alt="Customer">
          <div>
      ...
      <div class="testimonial">
        <div class="stars">⭐⭐⭐⭐⭐</div>
        <p>"Professional, punctual, and exceeded expectations. Will definitely use again!"</p>
        <div class="author">
          <img src="https://source.unsplash.com/150x150/?portrait,professional,female,headshot" alt="Customer">
          <div>
      ...
      <div class="testimonial">
        ...
        <div class="author">
          <img src="https://source.unsplash.com/150x150/?portrait,professional,person,headshot" alt="Customer">
          <div>
