...
export default function GoogleBusiness({ apiUrl, user }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        {/* RIGHT COLUMN - Why It's Important */}
        <div className="space-y-6">
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-sm leading-relaxed">
                      Google prioritizes businesses that actively engage with customers. Responding to reviews signals that you're an active, customer-focused business, which can improve your local search ranking by up to <strong>35%</strong>.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-5 border border-green-200">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-sm leading-relaxed">
                      <strong>89% of consumers</strong> read business responses to reviews. When potential customers see you actively responding, they're more likely to choose your business over competitors who don't engage.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-5 border border-green-200">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-sm leading-relaxed">
                      Responding professionally to negative reviews shows you care about customer satisfaction. <strong>45% of customers</strong> are more likely to visit a business if it responds to negative reviews constructively.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-5 border border-green-200">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">Increases Engagement & Visibility</h4>
                    <p className="text-gray-700 text-sm leading-relaxed">
                      Each review response adds fresh content to your Google Business Profile. This activity keeps your profile dynamic and signals to Google that your business is active, leading to better visibility in "near me" searches.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-5 border border-green-200">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">Shows You Value Feedback</h4>
                    <p className="text-gray-700 text-sm leading-relaxed">
                      Thanking customers for positive reviews and addressing concerns in negative ones demonstrates professionalism. This builds loyalty and encourages repeat business and referrals.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="flex-1">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-3">
                <div className="flex gap-3">
                  <div className="w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center flex-shrink-0 font-bold text-sm">1</div>
                  <p className="text-gray-700 text-sm">Open your <strong>Google Business Profile</strong> at business.google.com</p>
                </div>
                <div className="flex gap-3">
                  <div className="w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center flex-shrink-0 font-bold text-sm">2</div>
                  <p className="text-gray-700 text-sm"><strong>Copy the review text</strong> from a customer review</p>
                </div>
                <div className="flex gap-3">
                  <div className="w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center flex-shrink-0 font-bold text-sm">3</div>
                  <p className="text-gray-700 text-sm"><strong>Paste it here</strong>, select the star rating, and add the customer's name (optional)</p>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex gap-3">
                  <div className="w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center flex-shrink-0 font-bold text-sm">4</div>
                  <p className="text-gray-700 text-sm">Click <strong>"Generate AI Reply"</strong> and watch the magic happen! ✨</p>
                </div>
                <div className="flex gap-3">
                  <div className="w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center flex-shrink-0 font-bold text-sm">5</div>
                  <p className="text-gray-700 text-sm">Review the AI response, click <strong>"Copy to Clipboard"</strong></p>
                </div>
                <div className="flex gap-3">
                  <div className="w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center flex-shrink-0 font-bold text-sm">6</div>
                  <p className="text-gray-700 text-sm"><strong>Paste the reply</strong> back in Google Business Profile and post! 🎉</p>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-3">
              <ul className="space-y-2 text-sm text-gray-700">
                ...
                <li className="flex gap-2">
                  <span className="text-yellow-600">•</span>
                  <span>For low-star reviews (1-3 stars), the AI generates empathetic, solution-focused responses</span>
                </li>
                <li className="flex gap-2">
                  <span className="text-yellow-600">•</span>
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                ...
                <li className="flex gap-2">
                  <span className="text-yellow-600">•</span>
                  <span>Regular responses boost your visibility in Google searches</span>
                </li>
              </ul>
            </div>
          </div>
