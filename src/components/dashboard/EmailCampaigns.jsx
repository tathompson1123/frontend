          ...
          <div className="border border-gray-200 rounded-xl p-4">
            ...
            <div className="mb-3">
              <div className="flex items-center gap-2 px-3 py-2 bg-green-50 border border-green-200 rounded-lg">
                ...
                <span className="text-green-700 text-xs font-semibold">Email active</span>
                <span className="text-xs text-green-500 ml-auto">Campaigns sent on your behalf — replies go to your email</span>
              </div>
            </div>
